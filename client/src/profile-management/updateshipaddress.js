...
function NewShippingAddress() {
    ...
    const updateShipAddress = () => {
        const ShipAddressID = localStorage.getItem("ShipAddressID");
        window.localStorage.removeItem("ShipAddressID");

        Axios.post("http://localhost:3001/shipaddress/updateshipaddress", {
...
<InputGroup size="sm" className="mb-3">
    ...
    onClick={updateShipAddress}>
Update</Button>{" "}<Button variant="secondary" href="/mngshipaddress">
