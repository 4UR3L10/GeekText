...
function ManageSettings() {
    ...
    const updateStatus = () => { // Update Anonymus Status.
...
<InputGroup size="sm" className="mb-3">
    ...
    <FormControl aria-label="Small" aria-describedby="inputGroup-sizing-sm"
        ...
        }/></InputGroup>{/* State.*/}<InputGroup size="sm" className="mb-3">
<InputGroup.Prepend>
    <InputGroup.Text id="inputGroup-sizing-sm">
        State
    </InputGroup.Text>
</InputGroup.Prepend><FormControl aria-label="Small" aria-describedby="inputGroup-sizing-sm"
    onChange={
        (e) => {
            setStateReg(e.target.value);
        }
    }/></InputGroup>{/* Zip Code.*/}<InputGroup size="sm" className="mb-3"><InputGroup.Prepend>
<InputGroup.Text id="inputGroup-sizing-sm">
    Zip Code</InputGroup.Text></InputGroup.Prepend><FormControl aria-label="Small" aria-describedby="inputGroup-sizing-sm"
    onChange={
        (e) => {
            setZipCodeReg(e.target.value);
        }
    }/></InputGroup>{/* Country.*/}<InputGroup size="sm" className="mb-3"><InputGroup.Prepend><InputGroup.Text id="inputGroup-sizing-sm">Country</InputGroup.Text></InputGroup.Prepend><FormControl aria-label="Small" aria-describedby="inputGroup-sizing-sm"
    onChange={
        (e) => {
            setCountryReg(e.target.value);
        }
    }/></InputGroup>{/* Buttons.*/}<div><Button variant="primary"
    onClick={updateAddress}>Save Changes</Button>{" "}<Button variant="secondary" href="/mngaccount">Cancel</Button>{" "} </div><br/> {/* TextHeader.*/}<div className="mainheader"><Container><h2>Change Your Anonymus Status</h2></Container></div>{/* Anonymus.*/}<Form.Group controlId="formBasicCheckbox"><Form.Check type="checkbox" value="Y" label="Remain Anonymus"
    onChange={
        (e) => {
            setAnonymusStatReg(e.target.value);
        }
    }/></Form.Group>{/* Buttons.*/}<div><Button variant="primary"
    onClick={updateStatus}>Save Changes</Button>{" "}<Button variant="secondary" href="/mngaccount">Cancel</Button>{" "} </div><br/> {/* TextHeader.*/}<div className="mainheader"><Container><h2>Change Your Nickname</h2></Container></div>{/* Nickname.*/}<InputGroup size="sm" className="mb-3"><InputGroup.Prepend><InputGroup.Text id="inputGroup-sizing-sm">Nickname</InputGroup.Text></InputGroup.Prepend><FormControl aria-label="Small" aria-describedby="inputGroup-sizing-sm"
    onChange={
        (e) => {
            setNickNameReg(e.target.value);
        }
    }/></InputGroup></label>{/* Buttons.*/}<div><Button variant="primary"
    onClick={updateNickname}>Save Changes</Button>{" "}<Button variant="secondary" href="/mngaccount">Cancel</Button>{" "} </div><br/></div></div> </div>
        );
    } else { // Not Logged In.
        return (
            <div className="App">
