                ...
                <div>
                    <Switch>
                        ...
                        <Route exact path="/signup"
                            component={signup}/>
                        <Route exact path="/mngsettings"
                            component={mngsettings}/>
                        <Route exact path="/newshipaddress"
                            component={newshipaddress}/>
                        <Route exact path="/newpayment"
                            component={newpayment}/>
                        <Route exact path="/mngpayment"
                            component={mngpayment}/>
                        <Route exact path="/mngshipaddress"
                            component={mngshipaddress}/>
                        <Route exact path="/updateshipaddress"
